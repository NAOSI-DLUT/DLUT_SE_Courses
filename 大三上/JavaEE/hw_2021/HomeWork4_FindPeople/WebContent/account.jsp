...
<form action="AdminServlet" method="get">
    <p><input type="text" style="width:500px; height:50px;" name="id" placeholder="输入要修改的学号">
        <input style="width:500px; height:50px;" type="text" name="name" placeholder="输入要修改的姓名">
        <input style="width:500px; height:50px;" type="text" name="tel" placeholder="输入要修改的电话">
        <input style="width:500px; height:50px;" type="text" name="qq" placeholder="输入要修改的QQ">
        <input style="width:500px; height:50px;" type="text" name="mail" placeholder="输入要修改的邮箱">
...
<form action="SearchServlet" method="post">
    <p>
    <input type="text" style="width:500px; height:50px;" name="query" placeholder="输入要查询的学号"/>
