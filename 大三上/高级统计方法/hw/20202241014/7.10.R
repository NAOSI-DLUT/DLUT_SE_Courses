...
# All cp, BIC and adjr2 scores show that size 6 is 
# the minimum size for the subset for which the scores
#  are withing 0.2 standard deviations of optimum. 
#  We pick 6 as the best subset size and find best 6 
#  variables using entire data.
...
# test.rss
## [1] 0.7697
# We obtain a test R-squared of 0.77 
# using GAM with 6 predictors. 
# This is a slight improvement over a test RSS of 
# 0.74 obtained using OLS.
...
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
# Non-parametric Anova test shows a strong evidence of
#  non-linear relationship between response and Expend,
#  and a moderately strong non-linear relationship 
#  (using p value of 0.05) between response and Grad.
#  Rate or PhD.