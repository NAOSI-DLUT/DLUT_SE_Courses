...
# Summary shows that all polynomial terms are 
# significant while predicting nox using dis. 
# Plot shows a smooth curve fitting the data fairly well.

# b
# We plot polynomials of degrees 1 to 10 and save 
# train RSS.
...
# As expected, train RSS monotonically decreases 
# with degree of polynomial.

# c
# We use a 10-fold cross validation to pick 
...
# A 10-fold CV shows that the CV error reduces 
# as we increase degree from 1 to 3, 
# stay almost constant till degree 5, and the
# starts increasing for higher degrees. 
# pick 4 as the best polynomial degree.

# d
# We see that dis has limits of about 1 
# and 13 respectively. We split this range in 
# roughly equal 4 intervals and establish knots
#  at [4,7,11]. 
# Note: bs function in R expects 
#  either df or knots argument. 
#  If both are specified, knots are ignored.
...
# The summary shows that all terms in spline 
# fit are significant. Plot shows that the spline 
# fits data well except at the extreme values of dis, 
# (especially dis>10).
...
# Train RSS monotonically decreases till df=14 
# and then slightly increases for df=15 and df=16.

# f
# Finally, we use a 10-fold cross validation to find
#  best df. We try all integer values of df between 3 
#  and 16.
...
# CV error is more jumpy in this case, 
# but attains minimum at df=10. 
# We pick 10 as the optimal degrees of freedom.